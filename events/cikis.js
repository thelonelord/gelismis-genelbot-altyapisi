...
module.exports = async member => {
  ...
  let memberChannel = await db.fetch(`gcc_${member.guild.id}`)
   ...
   // const channel = guild.channels.cache.get(channelId)
    ...
    const background = await Canvas.loadImage("https://media.discordapp.net/attachments/1004036160185716776/1004059435494297620/20210602_155428.jpg")
    let x = 0
    let y = 0
    ...
    let text = `Görüşürüz ${member.user.tag}!`
